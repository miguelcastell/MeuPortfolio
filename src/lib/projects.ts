...
export const projects: Project[] = [
  ...
  },
  {
    slug: 'recomendaai',
    title: 'RecomendaAI',
    description: 'Sistema de recomendação de filmes com Machine Learning combinando Collaborative Filtering e abordagem híbrida.',
    longDescription:
      'RecomendaAI implementa um motor de recomendação completo, com tratamento do problema de cold start via fallback baseado em conteúdo e avaliação com métricas ranqueadas (Precision@K, NDCG).',
    tags: ['Machine Learning', 'Python', 'Recomendação', 'NLP'],
    stack: ['Python', 'Scikit-learn', 'Pandas', 'NumPy', 'Streamlit'],
    metrics: [
      { label: 'Precision@10 em ambiente de teste', value: '78%' },
      { label: 'NDCG médio', value: '0.82' },
      { label: 'Usuários simulados no dataset', value: '10k+' },
    ],
    github: 'https://github.com/miguelcastell/RecomendaAI',
    featured: true,
    tier: 1,
    status: 'in-progress',
